...
public class ModConfiguredFeatures {
    public static final ResourceKey<ConfiguredFeature<?, ?>> OVERWOLRD_RUBY_ORE_KEY = registerKey("ruby_ore");
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, OVERWOLRD_RUBY_ORE_KEY, Feature.ORE, new OreConfiguration(overworldRubyOres, 3));

    }

    public static ResourceKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, ResourceLocation.fromNamespaceAndPath(NecessariesMod.MOD_ID, name));
    }
